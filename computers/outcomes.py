...
def compute(
    ...
    """Return {developer_key: {goal_achievement_rate, helpfulness_score, session_types}}.

    meta_by_sid: pre-built {session_id: session_meta} index — no iteration of session_metas needed.
    """
