...
def compute(skill_events: list[dict]) -> dict[str, dict]:
    """
    Input: pre-filtered skill events (event_type == 'skill') from batch_runner.
    Return {developer_key: {invocations_per_week, unique_skills, high_value_pct, by_skill}}.
    """
