...
def compute(
    ...
    total_developers: int | None = None,
    period_days: int = 7,
) -> dict:
    """
    Compute adoption metrics per developer and team-level.

    sessions_by_dev: pre-grouped {developer_key: [session_meta, ...]}
    total_developers: size of the whole team (for team_coverage_pct).
                      If None, uses unique developers seen in data.
    """
